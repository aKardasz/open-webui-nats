...
AUTOMATION_NATS_SUBJECT = os.environ.get('AUTOMATION_NATS_SUBJECT', 'owui.cmd.automation.run').strip()
if not AUTOMATION_NATS_SUBJECT:
    AUTOMATION_NATS_SUBJECT = 'owui.cmd.automation.run'

AUTOMATION_NATS_REQUEST_TIMEOUT = os.environ.get('AUTOMATION_NATS_REQUEST_TIMEOUT', '10')
try:
    AUTOMATION_NATS_REQUEST_TIMEOUT = float(AUTOMATION_NATS_REQUEST_TIMEOUT)
    if AUTOMATION_NATS_REQUEST_TIMEOUT <= 0:
        AUTOMATION_NATS_REQUEST_TIMEOUT = 10.0
except ValueError:
    AUTOMATION_NATS_REQUEST_TIMEOUT = 10.0

ENABLE_EMBEDDED_AUTOMATION_RUNNER = os.environ.get('ENABLE_EMBEDDED_AUTOMATION_RUNNER', 'true').lower() == 'true'
AUTOMATION_RUNNER_ONLY_MODE = os.environ.get('AUTOMATION_RUNNER_ONLY_MODE', 'false').lower() == 'true'
...
RETRIEVAL_JOB_SIGNING_SECRET = os.environ.get('RETRIEVAL_JOB_SIGNING_SECRET', '').strip() or WEBUI_SECRET_KEY
