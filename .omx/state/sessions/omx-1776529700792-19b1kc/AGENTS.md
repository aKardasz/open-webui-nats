...
<!-- OMX:RUNTIME:START -->
<session_context>
**Session:** omx-1776529700792-19b1kc | 2026-04-18T16:28:21.906Z

**Codebase Map:**
  src/: app.d
  src/routes/: +layout
  scripts/: prepare-pyodide
  backend/: loader, swagger-ui-bundle
  cypress/: chat.cy, documents.cy, registration.cy, settings.cy, e2e, index.d
  static/: loader
  (root): cypress.config, i18next-parser.config, postcss.config, svelte.config, tailwind.config, vite.config
